...
🎯 TEXT CHUNKS - FIXED IMPORTS



CHANGES:

✅ Import from law_extraction_enhanced (NOT law_extraction_utils)

✅ Import from law_validation
...
def extract_hierarchical_chunks(
    ...
    """Extract chunks with VALIDATED citations"""
    ...
    try:
        ...
        # ✅ GET laws_structured (già validate da 01b_reenrich_laws.py)

        doc_level_laws_cleaned = sem_meta.get("laws_structured", [])

        

        # ✅ Se non ci sono, estrai + valida al volo
        ...
        if summary_text and len(summary_text) > 50:
            ...
            chunk_metas.append({
                ...
                "payload": {
                    ...
                    "neo4j_law_ids": [law['law_id'] for law in doc_level_laws_cleaned],

                    "neo4j_law_urns": [law['urn'] for law in doc_level_laws_cleaned],

                    "neo4j_law_prefixes": [law['qdrant_prefix'] for law in doc_level_laws_cleaned],
...
def index_text_chunks(client: QdrantClient, model: SentenceTransformer):

    """Index text chunks with VALIDATED citations"""
    ...
    print(f"🚀 INDEXING TEXT (VALIDATED LAWS): {collection_name}")
    ...
    print("📦 STEP 1/3: Extracting chunks with validated citations...\n")
    ...
    print(f"   Truncated docs (≥50 chunks): {stats['truncated_docs']}")
    ...
    print(f"   Chunks with law citations: {with_citations:,}")
...
if __name__ == "__main__":
    ...
    count = index_text_chunks(client, model)
