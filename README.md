...
- **LLM Agent for Compliance Workplace Safety (2025)** – End to end **graphRAG system** for workplace safety, processing 2000+ regulatory documents using *Python*, *Docling*, with *vector databases* storage and multi-layer normative **knowledge graph**.  
